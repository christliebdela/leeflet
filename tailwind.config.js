  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        brand: ['"Instrument Serif"', '"Newsreader"', '"Playfair Display"', '"Cormorant Garamond"', 'Georgia', 'serif'],
      },
      boxShadow: {
        ...
        'sticky': '0 10px 15px -3px rgba(0, 0, 0, 0.08), 0 4px 6px -4px rgba(0, 0, 0, 0.05)',
      },
      borderRadius: {
        'none': '0',
        'xs': '2px',
