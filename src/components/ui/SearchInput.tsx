  ...
  return (
    <div className={`relative flex items-center ${className}`}>
      ...
      <input
        ...
        className="w-full pl-9 pr-16 py-1 bg-[#f4f5f6] dark:bg-[#1c1c1f] text-xs font-medium text-[#111827] dark:text-[#f4f4f5] placeholder-[#9ca3af] dark:placeholder-[#71717a] rounded-[6px] border border-[#e5e7eb] dark:border-[#27272a] focus:bg-white dark:focus:bg-[#222226] focus:border-[#9ca3af] dark:focus:border-[#52525b] focus:outline-none transition-all"
        {...props}
      />
